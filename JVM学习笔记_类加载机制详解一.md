...
2. 在java代码中，类型的加载、连接与初始化过程都是在程序运行期间完成的。

3. 提供了更大的灵活性，增加了更多的可能性。
...
- <font color="red">**3.初始化**:为类的静态变量赋予正确的初始值</font>
...
> 4. iconst_1表示将int类型1推送至栈顶((iconst_m1,iconst_0 ~ iconst_5))
